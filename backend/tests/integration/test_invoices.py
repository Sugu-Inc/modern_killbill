...
def test_list_invoices_via_api(client: TestClient) -> None:
    ...
    response = client.get(f"/v1/invoices?account_id={account_id}")
...
def test_void_invoice_via_api(client: TestClient) -> None:
